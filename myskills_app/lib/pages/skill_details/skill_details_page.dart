...
class _SkillDetailsScreenState extends State<SkillDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    void changeUserLevel() {
      cubit.updateSkillLevel(skillId, selectedLevel!);
      // refresh the page.
    ...
    return BlocConsumer<UpdateCurrentSkillCubit, UpdateCurrentSkillState>(
